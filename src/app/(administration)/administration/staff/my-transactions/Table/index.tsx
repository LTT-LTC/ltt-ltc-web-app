...
import MyTransactionsFilter from "../Filter";
import Link from "next/link";

const MyTransactionsListPage = () => {
  return (
    <>
      <LTTBreadcrumb
        items={[
          { title: "Nhan vien" },
          { title: <Link href="/administration/staff/my-transactions">Giao dich cua toi</Link> },
        ]}
      />
...
export default MyTransactionsListPage;
