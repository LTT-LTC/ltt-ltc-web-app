...
export default function UserDropdown() {
  ...
  function getAvatarLetter(fullName: string) {
    if (!fullName) return "";
      ...
      >
        <span
          className="mr-3 overflow-hidden rounded-full h-11 w-11
                 flex items-center justify-center bg-gray-400 text-white font-semibold"
        >
          {avatarUrl ? (
            <Image width={44} height={44} src={avatarUrl} alt="User" />
          ) : (
